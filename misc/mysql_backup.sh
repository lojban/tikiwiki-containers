...
mysql tiki -e 'delete from sessions where expiry < UNIX_TIMESTAMP();'

mysql tiki -e 'truncate tiki_stats;'

mysql tiki -e 'delete from tiki_actionlog where lastmodif < UNIX_TIMESTAMP(CURRENT_DATE() - INTERVAL 6 MONTH);'
